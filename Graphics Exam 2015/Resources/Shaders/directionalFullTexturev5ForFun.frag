...
void main()
{
	...
	vec4 diffuseColor = calculateDiffuseColor(materialDiffuseColor, vec3(textureColor), lightDirection_cameraspace);
	vec4 specularColor = calculateSpecularColor(materialSpecularColor, vec3(textureColor), lightDirection_cameraspace, specularExponent);
